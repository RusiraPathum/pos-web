...
var FullCalendar = (function (exports) {
    ...
    */
    function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context) {
        ...
        // help out EventApi from having login modify props
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        Object.defineProperty(EventApi.prototype, "classNames", {
            // NOTE: login can't modify these because Object.freeze was called in event-def parsing
    ...
    */
    ...
    /*
    Detects when the login clicks on an event within a DateComponent
    */
    ...
    /*
    Triggers events and adds/removes core classNames when the login's pointer
    ...
    */
    var PointerDragging = /** @class */ (function () {
        ...
        // can be called by login of this class, to cancel touch-based scrolling for the current drag
    ...
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.buildCaches = function (scrollStartEl) {
            return this.queryScrollEls(scrollStartEl).map(function (el) {
                if (el === window) {
                    return new WindowScrollGeomCache(false); // false = don't listen to login-generated scrolls
                }
                return new ElementScrollGeomCache(el, false); // false = don't listen to login-generated scrolls
            });
        };
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.isInteracting = false; // is the login validly moving the pointer? lasts until pointerup
    ...
    */
    ...
    /*
    Monitors when the login clicks on a specific date/time of a component.
    ...
    */
    ...
    /*
    Tracks when the login selects a portion of time of a component,
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                // if touch, require login to hold down
