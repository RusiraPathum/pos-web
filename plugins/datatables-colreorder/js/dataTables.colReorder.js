...
$.extend( ColReorder.prototype, {
	...
	/**
	 * Enable / disable end login interaction
	 */
	...
	"_fnMouseMove": function ( e )
	{
		...
		if ( this.dom.drag === null )
		{
			 ...
			 * point - this allows the login to make small mouse movements when sorting and not have a
	...
	/**
	 * Copy the TH element that is being drags so the login has the idea that they are actually
...
ColReorder.defaults = {
	...
	/**
	 * Redraw the table's column ordering as the end login draws the column
