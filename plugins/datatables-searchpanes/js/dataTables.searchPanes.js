...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
         ...
         *
         * @param display the value to be displayed to the login
        ...
        SearchPane.prototype._setListeners = function () {
            ...
            this.s.dtPane.off('login-select.dtsp');
            this.s.dtPane.on('login-select.dtsp', function (e, _dt, type, cell, originalEvent) {
                ...
                columnDefs: [
                    {
                        ...
                        // This is null if not defined by the login, meaning that automatic type detection
                        //  would take place
         ...
         *
         * @returns {object} The options for the row extended to include the options from the login.
         */
