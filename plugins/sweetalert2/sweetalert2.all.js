...
(function (global, factory) {
  ...
  // elements not within the active modal dialog will not be surfaced if a login opens a screen
  ...
  var handlePopupClick = function handlePopupClick(instance, domCache, dismissWith) {
    ...
    if (innerParams.toast) {
      ...
      // This can happen when the login drags a slider
